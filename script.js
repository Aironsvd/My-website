...
function showGiftScene() {
    ...
    giftScene.className = "gift-scene";
    ...
    const giftBox =
        giftScene.querySelector(".gift-box");
    ...
    /* Also allow tapping the instruction */

    const tapText =
        giftScene.querySelector(".tap-gift");
...
function openGift(giftScene) {
    ...
    /*
       Chapter 3 will eventually begin here.

       For now we pause after the magical
       opening so we can test the animation.
    */

    setTimeout(() => {

        const message =
            giftScene.querySelector(".gift-message");
